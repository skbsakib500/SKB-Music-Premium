...
class HiResUpsampler(
    ...
    override fun configure(
        ...
        return AudioProcessor.AudioFormat(
            C.ENCODING_PCM_FLOAT, channels, outRate
        )
    }

    override fun isActive(): Boolean = active
    override fun isEnded(): Boolean = inputEnded && !output.hasRemaining()
    ...
    private fun readAsFloat(buf: ByteBuffer): FloatArray {
        ...
        for (i in 0 until n) {
            out[i] = when (inEncoding) {
                ...
                C.ENCODING_PCM_16BIT -> buf.short.toFloat() / 32768f
                ...
                C.ENCODING_PCM_32BIT -> buf.int.toFloat() / 2147483648f
                else -> 0f
            }
        }
        return out
